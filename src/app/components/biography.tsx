...
export default function Biography() {
  return (
    <section className="bg-gray-900 text-white relative h-96">
      <div className="grid grid-cols-2 h-full items-center justify-center lg:px-24 container mx-auto">
        <Image
          src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2102&q=80"
          alt="person"
          width={380}
          height={300}
          className="rounded-2xl object-none w-72 absolute -top-6"
        />
        <p></p>
        <div>
          <svg
            ...
            viewBox="0 0 162 128"
            strokeWidth="1"
            className="w-24 sm:w-36 absolute fill-gray-900 top-14 stroke-gray-600"
          >
            <path
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400">CEO / Mentor at Pianotopia</p>
          </div>
        </div>
      </div>
    </section>
